...
// the name of the granted blessing is of the form <idp>/o/<clientID>/<email> where <idp>
...
func (a *accessTokenBlesser) blessingExtension(r *http.Request) (string, error) {
	...
	// We use o/<clientID>/<email> as the extension in order to namespace the blessing under
	...
	return strings.Join([]string{"o", clientID, email}, security.ChainSeparator), nil
}
