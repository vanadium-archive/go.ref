...
// The blessings for specific ClientIDs can be customized by passing a non-nill
// RegisteredAppMap.
//
...
func NewOAuthBlessingHandler(ctx *context.T, params blesser.OAuthBlesserParams, apps RegisteredAppMap) http.Handler {
	if apps == nil {
