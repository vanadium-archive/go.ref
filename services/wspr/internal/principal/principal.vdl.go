...
func (m *BlessingsCacheAddMessage) FillVDLTarget(t vdl.Target, tt *vdl.Type) error {
	...
	if var4 {
		if err := fieldsTarget1.ZeroField("CacheId"); err != nil && err != vdl.ErrFieldNoExist {
			return err
		}
	} else {
...
func (t *BlessingsCacheAddMessageTarget) ZeroField(name string) error {
	switch name {
	case "CacheId":
		t.Value.CacheId = BlessingsId(0)
		return nil
	case "Blessings":
		...
		return nil
	default:
		return fmt.Errorf("field %s not in struct v.io/x/ref/services/wspr/internal/principal.BlessingsCacheAddMessage", name)
	}
}
...
func (m *BlessingsCacheDeleteMessage) FillVDLTarget(t vdl.Target, tt *vdl.Type) error {
	...
	if var7 {
		if err := fieldsTarget1.ZeroField("DeleteAfter"); err != nil && err != vdl.ErrFieldNoExist {
			return err
		}
	} else {
...
func (t *BlessingsCacheDeleteMessageTarget) ZeroField(name string) error {
	switch name {
	case "CacheId":
		t.Value.CacheId = BlessingsId(0)
		return nil
	case "DeleteAfter":
		t.Value.DeleteAfter = uint32(0)
		return nil
	default:
		return fmt.Errorf("field %s not in struct v.io/x/ref/services/wspr/internal/principal.BlessingsCacheDeleteMessage", name)
	}
}
