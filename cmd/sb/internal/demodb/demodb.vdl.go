...
func (t *Array2StringTarget) FromZero(tt *vdl.Type) error {
	*t.Value = Array2String{}
	return nil
}
...
func (t *CompositeTarget) FromZero(tt *vdl.Type) error {
	*t.Value = Composite{}
	return nil
}
...
func (t *TimesTarget) FromZero(tt *vdl.Type) error {
	*t.Value = Times{}
	return nil
}
...
func (m *Recursive) FillVDLTarget(t vdl.Target, tt *vdl.Type) error {
	...
	if err != vdl.ErrFieldNoExist {
		...
		var4 := (m.Any == vom.RawBytesOf(vdl.ZeroValue(vdl.AnyType)))
		if var4 {
			if err := fieldTarget3.FromZero(tt.NonOptional().Field(0).Type); err != nil {
				return err
			}
...
func (t *RecursiveTarget) FromZero(tt *vdl.Type) error {
	*t.Value = Recursive{
...
func (t *__VDLTarget4_optional) FromZero(tt *vdl.Type) error {
	*t.Value = (*Times)(nil)
	return nil
}
...
func (t *__VDLTarget5_map) FromZero(tt *vdl.Type) error {
	*t.Value = map[Array2String]Recursive(nil)
	return nil
}
...
func (t *ActOrSatScoreTarget) FromZero(tt *vdl.Type) error {
	*t.Value = ActOrSatScore(ActOrSatScoreActScore{})
	return nil
}
...
func (t *StudentTarget) FromZero(tt *vdl.Type) error {
	*t.Value = Student{
...
func (m *AnythingGoes) FillVDLTarget(t vdl.Target, tt *vdl.Type) error {
	...
	if err != vdl.ErrFieldNoExist {
		...
		var7 := (m.Anything == vom.RawBytesOf(vdl.ZeroValue(vdl.AnyType)))
		if var7 {
			if err := fieldTarget6.FromZero(tt.NonOptional().Field(1).Type); err != nil {
				return err
			}
...
func (t *AnythingGoesTarget) FromZero(tt *vdl.Type) error {
	*t.Value = AnythingGoes{
