...
B: 123,
		...
		{"TypeObjectBool", vdl.TypeObjectValue(vdl.BoolType), `vdl.BoolType`},
		{"TypeObjectString", vdl.TypeObjectValue(vdl.StringType), `vdl.StringType`},
		{"TypeObjectBytes", vdl.TypeObjectValue(vdl.ListType(vdl.ByteType)), `vdl.TypeOf((*[]byte)(nil))`},
		{"TypeObjectByte", vdl.TypeObjectValue(vdl.ByteType), `vdl.ByteType`},
		{"TypeObjectUint16", vdl.TypeObjectValue(vdl.Uint16Type), `vdl.Uint16Type`},
		{"TypeObjectInt16", vdl.TypeObjectValue(vdl.Int16Type), `vdl.Int16Type`},
		{"TypeObjectFloat32", vdl.TypeObjectValue(vdl.Float32Type), `vdl.Float32Type`},
