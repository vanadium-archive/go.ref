...
type (
	...
	__PrimitiveReflect struct {
		Name  string "v.io/core/veyron/lib/vom.Primitive"
		Type  Primitive
		Union struct {
...
func (DumpAtom) __VDLReflect(struct {
	Name string "v.io/core/veyron/lib/vom.DumpAtom"
}) {
}
...
func (DumpKind) __VDLReflect(struct {
	Name string "v.io/core/veyron/lib/vom.DumpKind"
...
func (ControlKind) __VDLReflect(struct {
	Name string "v.io/core/veyron/lib/vom.ControlKind"
